...
public final class CommandFingerprint {
    ...
    /**
     * Хеширует нормализованные значения команды без JSON и внешних эффектов.
     * Формат строк намеренно сохранён: его изменение нарушило бы сравнение старых receipts.
     */
